...
export const UserDetails = () => {
    ...
    return (
        <div className={UserDetailsCSS.mainContainer}>
            <div className={UserDetailsCSS.mainContainer__imgContainer}>
            ...
            <div className={UserDetailsCSS.mainContainer__userDetailsContainer}>
                <div className={UserDetailsCSS.mainContainer__userDetailsContainer__nameContainer}>
                    <h2 className={UserDetailsCSS.mainContainer__userDetailsContainer__nameContainer__userName}>{userDetailsInfo ? userDetailsInfo.name : null}</h2>
                </div>
                <div className={UserDetailsCSS.mainContainer__userDetailsContainer__descriptionContainer}>
