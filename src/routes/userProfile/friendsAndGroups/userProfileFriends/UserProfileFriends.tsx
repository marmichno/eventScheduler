                ...
                return (
                    <div className={UserProfileFriendsCSS.mainContainer__friendContainer}>
                        <div className={UserProfileFriendsCSS.mainContainer__friendContainer__avatarContainer}>
                            <img data-username={val.name} onClick={(e) => goToUserProfile(e)} src="https://images.unsplash.com/flagged/photo-1570612861542-284f4c12e75f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"></img>
                        </div>
